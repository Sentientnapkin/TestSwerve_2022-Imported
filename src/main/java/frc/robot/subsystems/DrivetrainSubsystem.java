...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private final com.kauailabs.navx.frc.AHRS m_navx = new com.kauailabs.navx.frc.AHRS(SPI.Port.kMXP, (byte) 200); // NavX connected over MXP
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Gyro Angle", m_navx.getYaw());
